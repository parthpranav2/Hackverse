...
class BSFragmentFilter_addhackathon : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.bottomsheet_fragment_filter_addhackathon, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        selectedPosition = GlobalClass.FilterAddHackathon
        ...
        listView.setOnItemClickListener { _, _, position, _ ->
            ...
            GlobalClass.FilterAddHackathon = position
