...
class PendingRegistrationsFragment : Fragment() , PendingRegistrationsAdapter.OnTeamDetailsClickListener{
    private lateinit var recyclerView : RecyclerView
    private lateinit var teamArrayList : ArrayList<TeamParsableModel>//temporary model
    private lateinit var pendingregistrationaAdapter : PendingRegistrationsAdapter //temporary adapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pending_registrations, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        recyclerView = view.findViewById(R.id.recvwpendingregistrations)
        recyclerView.layoutManager = LinearLayoutManager(context)
        teamArrayList = arrayListOf()
        pendingregistrationaAdapter = PendingRegistrationsAdapter(teamArrayList,this)
        recyclerView.adapter = pendingregistrationaAdapter
                    ...
                    if (teamId.isNotEmpty()) {
                        ...
                        teamRef.addListenerForSingleValueEvent(object : ValueEventListener {
                            override fun onDataChange(teamSnapshot: DataSnapshot) {
                                ...
                                if (!registrationCompleted) { // Only consider teams with registrationCompleted == false
    ...
    private fun fetchEventDetails(teamName: String, eventId: String, teamId: String) {
        ...
        eventRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(eventSnapshot: DataSnapshot) {
                ...
                pendingregistrationaAdapter.notifyDataSetChanged()
            }
