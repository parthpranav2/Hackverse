...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<LinearLayout>(R.id.tabBookmark).setOnClickListener{
            ...
            findViewById<TextView>(R.id.txtActiveTeamsCount).setTextColor(Color.parseColor("#969DA4"))
        ...
        findViewById<LinearLayout>(R.id.tabActiveTeams).setOnClickListener{
            ...
            findViewById<TextView>(R.id.txtActiveTeamsCount).setTextColor(Color.parseColor("#5E7BF0"))
