...
class FinalisedTeammatesAdapter(private val teamList: ArrayList<UserParsableModel>) : RecyclerView.Adapter<FinalisedTeammatesAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if(teamList[position].empRegistered=="T"){
